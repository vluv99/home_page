...
export class AppIcon extends HTMLElement {
    ...
    get width():number {
        return (Number.parseInt(this.getAttribute("width")) ? Number.parseInt(this.getAttribute("width")) : 100);
    }


    private height = this.width * this.aspectRatio;
